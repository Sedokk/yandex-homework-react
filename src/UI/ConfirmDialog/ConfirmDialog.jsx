...
function ConfirmDialog() {
  const [setIsOpen, removeTicket, isOpen] = useCart((s) => [
    s.setIsDialogOpen,
    s.removeTicket,
    s.isDialogOpen,
  ])
  ...
  return (
    <Portal>
      <div className={style.dialogContainer}>
        <div className={style.outlay} onClick={() => setIsOpen(false)}></div>
        <div className={style.dialog}>
          <div className={style.topContainer}>
            <h4 className={style.title}>Удаление билета</h4>
          ...
          <div className={style.btnsContainer}>
            <button
              className={classNames(style.btn, style.confirmBtn)}
